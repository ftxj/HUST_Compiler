...
void ReportError::ForStmtInitMissFormat()
{

}

void ReportError::ForStmtStepMissFormat()
{

}

void ReportError::TypeMissOperation()
{

}

void ReportError::TypeNotDecl()
{

}

void ReportError::InheritSelf()
{

}

void ReportError::InterfaceConflict(ClassDecl*, Decl*, Decl*)
{
...
void ReportError::InterfaceNotImplemented(Decl *cd, AstType *interfaceType) {
    ostringstream s;
...
void ReportError::NewOpeartionTypeNotClass(Expr* exp, AstType* type)
{

}

void ReportError::IncompatibleOperands(Operator *op, AstType *lhs, AstType *rhs) {
    ostringstream s;
    Assert(lhs != nullptr);
    Assert(rhs != nullptr);
...
void ReportError::IncompatibleOperand(Operator *op, AstType *rhs) {
    ostringstream s;
...
void ReportError::ArgMismatch(Expr *arg, int argIndex, AstType *given, AstType *expected) {
  ostringstream s;
  s << "Incompatible argument " << argIndex << ": " << given << " given, " << expected << " expected";
  OutputError(arg->GetLocation(), s.str());
}

void ReportError::ReturnMismatch(ReturnStmt *rStmt, AstType *given, AstType *expected) {
    ostringstream s;
    s << "Incompatible return: " << given << " given, " << expected << " expected";
    OutputError(rStmt->GetLocation(), s.str());
}

void ReportError::FieldNotFoundInBase(Identifier *field, AstType *base) {
    ostringstream s;
    s << base << " has no such field '" << field <<"'";
    OutputError(field->GetLocation(), s.str());
}
     
void ReportError::InaccessibleField(Identifier *field, AstType *base) {
    ostringstream s;
    s  << base << " field '" << field << "' only accessible within class scope";
    OutputError(field->GetLocation(), s.str());
}

void ReportError::PrintArgMismatch(Expr *arg, int argIndex, AstType *given) {
    ostringstream s;
